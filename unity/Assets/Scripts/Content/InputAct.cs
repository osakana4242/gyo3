...
//     version 1.11.2
//     from Assets/etc/InputAct.inputactions
//
...
namespace Osakana4242.Content
{
    ...
    ""controlSchemes"": []
        ...
        ~@InputAct()
        {
            UnityEngine.Debug.Assert(!m_ShipAction.enabled, "This will cause a leak and performance issues, InputAct.ShipAction.Disable() has not been called.");
        }
        ...
        private List<IShipActionActions> m_ShipActionActionsCallbackInterfaces = new List<IShipActionActions>();
        ...
        public struct ShipActionActions
        {
            ...
            public void AddCallbacks(IShipActionActions instance)
            {
                if (instance == null || m_Wrapper.m_ShipActionActionsCallbackInterfaces.Contains(instance)) return;
                m_Wrapper.m_ShipActionActionsCallbackInterfaces.Add(instance);
            ...
            private void UnregisterCallbacks(IShipActionActions instance)
            {
                @Move.started -= instance.OnMove;
                @Move.performed -= instance.OnMove;
                @Move.canceled -= instance.OnMove;
            ...
            public void RemoveCallbacks(IShipActionActions instance)
            {
                if (m_Wrapper.m_ShipActionActionsCallbackInterfaces.Remove(instance))
                    UnregisterCallbacks(instance);
            }

            public void SetCallbacks(IShipActionActions instance)
            {
                foreach (var item in m_Wrapper.m_ShipActionActionsCallbackInterfaces)
                    UnregisterCallbacks(item);
                m_Wrapper.m_ShipActionActionsCallbackInterfaces.Clear();
